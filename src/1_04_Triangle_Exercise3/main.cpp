...
int main(){
    ...
    int successFragment2;
    char infoLogFragment2[512];
    glGetShaderiv(fragmentShader2, GL_COMPILE_STATUS, &successFragment2);
    if (!successFragment2) {
        glGetShaderInfoLog(fragmentShader2, 512, NULL, infoLogFragment2);
        cout << "ERROR::SHADER::FRAGMENT2::COMPILATION_FAILED\n" << infoLogFragment2 << endl;
    }
    ...
    int successProgram2;
    char infoLogProgram2[512];
    glGetProgramiv(shaderProgram2, GL_LINK_STATUS, &successProgram2);
    if(!successProgram2) {
        glGetProgramInfoLog(shaderProgram2, 512, NULL, infoLogProgram2);
        cout << "ERROR::SHADER::PROGRAM::COMPILATION_FAILED\n" << infoLogProgram2 << endl;
    }

    glDeleteShader(vertexShader);
    glDeleteShader(fragmentShader);
    glDeleteShader(fragmentShader2);//删除
